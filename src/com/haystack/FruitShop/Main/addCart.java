...
public class addCart extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // 插入或更新购物车信息
            String cartSql = "INSERT INTO myshopcart (GoodsName, GoodsType, GoodsIntroduce, GoodsPrice, GoodsQuantity) VALUES (?, ?, ?, ?, ?) " +
                    "ON DUPLICATE KEY UPDATE GoodsQuantity = GoodsQuantity + ?";
            try (PreparedStatement cartStatement = conn.prepareStatement(cartSql)) {
                ...
                cartStatement.setInt(6, intQuantity);
